...
public class Reloj {
    ...
    public Reloj(int segundo){
       ...
       public void setReloj(int segundo){
            ...
            int variableX = segundo / 60;
            if(variableX >= 60){
                this.horas = variableX / 60;
                this.minutos = variableX % 60;
            }else{
                this.horas = 0;
                this.minutos = variableX;
            }
    ...
    public void addReloj(Reloj reloj2){
        int totalsegundos = this.convertirSegundos() + reloj2.convertirSegundos();
        if(totalsegundos >= 86400){
            setReloj(totalsegundos-86400);
        }else{
    ...
    @Override
        ...
        public void restaReloj(Reloj reloj2){
            int diferencia = Math.abs(this.convertirSegundos() - reloj2.convertirSegundos());
            setReloj(diferencia);
        }

        private int convertirSegundos(){
